...
//This code does not accept parameters. It returns the amount of submitted requests that unapproved.
#include <stdio.h>
#include <stdlib.h>
#include <fcntl.h>
#include <unistd.h>
...
execlp("/bin/sh","sh","-c","ls -1 Loan/Result/Unapproved | wc -l",NULL);
